      ...
      <AnimatePresence mode="wait" custom={currentView === 'login' ? 'right' : 'left'}>
        {currentView === 'home' ? (
          ...
          <motion.div 
            ...
            animate="animate"
            exit="exit"
            className="w-full min-h-screen bg-gradient-to-br from-slate-100 via-blue-50/80 to-indigo-100/70 flex flex-col items-center justify-start p-4 md:p-6 lg:p-8 relative z-10 pt-20 pb-12 overflow-y-auto"
          >
            ...
            <button 
              ...
              className="absolute top-12 left-6 lg:left-12 flex items-center gap-2 text-slate-600 hover:text-blue-600 font-bold bg-white/60 px-4 py-2 rounded-xl backdrop-blur-md shadow-sm border border-white transition-all z-50 hover:-translate-x-1"
            >
              <ArrowLeft size={18} /> Back to Home
            </button>

            {/* Login Card */}
            <div className="w-full max-w-md bg-white/95 backdrop-blur-2xl rounded-3xl shadow-[0_20px_50px_rgba(30,58,138,0.12)] p-6 lg:p-8 z-10 border border-white shrink-0 mt-8 mb-8">
