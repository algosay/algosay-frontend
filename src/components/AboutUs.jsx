      ...
      <div className="max-w-6xl mx-auto space-y-16 pb-12">
        ...
        <div className="text-center space-y-6 animate-fade-in-up">
          ...
          <p className="text-lg md:text-2xl text-gray-400 max-w-3xl mx-auto font-light">
            Institutional-grade algorithmic backtesting engine, engineered for the modern quantitative trader.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Vision Card */}
          <div className="group relative bg-gray-900/60 border border-gray-800 rounded-2xl p-8 hover:border-cyan-500/55 transition-all duration-500 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] backdrop-blur-sm">
          ...
          {/* Mission Card */}
          <div className="group relative bg-gray-900/60 border border-gray-800 rounded-2xl p-8 hover:border-purple-500/55 transition-all duration-500 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] backdrop-blur-sm">
          ...
          <div className="space-y-10">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-3 text-lg leading-relaxed">
                  Say goodbye to browser crashes and high RAM usage. Our data engine caches and processes historical Spot, Futures, and Options market data directly from Cloudflare R2 object storage via DuckDB and Polars, evaluating massive multi-leg datasets instantly.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-3 text-lg leading-relaxed">
                  Powered by Google Generative AI, our platform parses natural language prompts (Tanglish, Hindi, English) into structured JSON backtest rules. Post-simulation, it analyzes your historical drawdown curves and trade metrics to provide deep strategic insights.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-3 text-lg leading-relaxed">
                  We provide historical backtesting analytics only—no live market execution or broker order routing. Furthermore, our engine calculates accurate historical taxation, exchange charges, and slippages so you evaluate realistic net simulation outcomes.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-red-950/10 border-l-4 border-red-500/70 rounded-r-xl p-6 md:p-8 backdrop-blur-sm">
          ...
          <p className="text-red-200/70 text-sm md:text-base leading-relaxed font-mono">
            AlgoSay is strictly a software tool for quantitative historical backtesting and data research. We are NOT a SEBI-registered Investment Advisor or Research Analyst, and we do not provide live trading or brokerage execution services. 9 out of 10 individual traders in the equity Futures and Options (F&O) segment incur net losses. Past simulation results do not guarantee future performance.
          </p>
        </div>
