...
import { Layers, Clock, Activity, Crosshair, ShieldCheck, Cpu } from 'lucide-react'; // 💎 Professional App Icons added
...
const strategyList = [
  {
    ...
    icon: <Layers strokeWidth={2.5} size={24} />
  },
  {
    id: 2,
    ...
    icon: <Clock strokeWidth={2.5} size={24} />
  },
  {
    id: 3,
  ...
  },
  {
    ...
    theme: {
      ...
      gradientStart: "from-amber-50/80"
    },
    ...
    icon: <Crosshair strokeWidth={2.5} size={24} />
  },
  {
    id: 5,
    ...
    icon: <ShieldCheck strokeWidth={2.5} size={24} />
  },
  {
    id: 6,
    ...
    icon: <Cpu strokeWidth={2.5} size={24} />
  }
];
...
const StrategyCapabilities = () => {
  ...
  return (
    // 💎 Removed background color and padding-top to make it blend 100% seamlessly with HomeView
    <section className="w-full pb-24 text-slate-900 relative z-10 bg-transparent">
      
      {/* 💎 Soft Pro Ambient Lights - Keeps the area colorful but subtle */}
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-6 md:px-12 lg:px-0">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20 pt-8">
          ...
          <motion.p 
            ...
            // 💎 Darker text (text-slate-600) for crystal clear readability
        ...
        >
          {strategyList.map((item, index) => (
            <motion.div
              ...
              // 💎 Glass-morphism effect (bg-white/80 + backdrop-blur) to look like a modern dashboard
              className={`bg-white/80 backdrop-blur-xl border border-slate-200/80 p-8 rounded-[1.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between transition-all duration-500 group cursor-default relative overflow-hidden ${item.theme.borderHover}`}
            >
              {/* Vibrant Glow Background on Hover */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-7">
                  <span className={`p-3 rounded-2xl border flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-sm ${item.theme.iconBg}`}>
                    {item.icon}
                  </span>
                ...
                {/* Description - High Contrast text-slate-600 */}
