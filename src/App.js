...
import TopNavBar from './components/TopNavBar'; // Correct path based on where you put it
import { useAppLogic } from './useAppLogic'; // Correct path
    ...
    <Router>
      <div className="min-h-screen bg-[#121212] text-gray-300 font-sans selection:bg-blue-500/30 relative flex flex-col justify-between">
        ...
        <div className="flex-grow">
          ...
          {/* 🚦 ROUTING SYSTEM 🚦 */}
          <Routes>
            {/* Main AlgoSay Backtesting Dashboard Route */}
            <Route path="/" element={
              <>
                <Header />
